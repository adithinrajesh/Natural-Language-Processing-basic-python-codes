...
2. Performing T-test to determine if the sequence of words form a collocation or not.
3. Performing Chi-Square test to determine if the sequence of words form a collocation or not.
